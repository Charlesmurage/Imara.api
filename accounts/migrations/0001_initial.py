    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('county', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.Counties')),
                ('major_skill', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='major_skill', to='accounts.Skills')),
                ('minor_skill', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='minor_skill', to='accounts.Skills')),
            ],
            options={
